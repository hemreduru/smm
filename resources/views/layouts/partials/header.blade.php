    ...
    <div class="container-fluid d-flex align-items-stretch justify-content-between">
        ...
        <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1">
            ...
            <div class="d-flex align-items-stretch flex-shrink-0">
                <!--begin::Language Switcher (Flag Toggle)-->
                <div class="d-flex align-items-center ms-1 ms-lg-3">
                    @if(app()->getLocale() == 'tr')
                        <a href="{{ route('settings.locale', 'en') }}"
                            class="btn btn-icon btn-active-light-primary w-30px h-30px w-md-40px h-md-40px">
                            <img src="{{ asset('assets/media/flags/united-states.svg') }}" alt="English"
                                class="h-20px w-20px rounded" />
                        </a>
                    @else
                        <a href="{{ route('settings.locale', 'tr') }}"
                            class="btn btn-icon btn-active-light-primary w-30px h-30px w-md-40px h-md-40px">
                            <img src="{{ asset('assets/media/flags/turkey.svg') }}" alt="Türkçe"
                                class="h-20px w-20px rounded" />
                        </a>
                    @endif
                </div>
                ...
                <div class="d-flex align-items-center ms-1 ms-lg-3">
                    @php
                        ...
                        $iconClass = $currentTheme == 'dark' ? 'bi-moon-fill' : 'bi-brightness-high';
                    @endphp
                    <a href="#" class="btn btn-icon btn-active-light-primary w-30px h-30px w-md-40px h-md-40px"
                        id="kt_theme_mode_toggle" data-kt-value="{{ $nextTheme }}">
                            ...
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <a href="#" class="fw-bold text-muted text-hover-primary fs-7">{{
                                        Auth::user()->email ?? 'email@example.com' }}</a>
                                </div>
                                <!--end::Username-->
                            </div>
                        </div>
